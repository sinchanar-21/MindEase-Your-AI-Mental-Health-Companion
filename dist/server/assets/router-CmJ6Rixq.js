...
const appCss = "/assets/styles-CWfR7UjT.css";
...
const Route$5 = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "A privacy-first, AI-powered companion for daily mood journaling, personalized coping strategies, and anonymous peer support."
      },
      { property: "og:title", content: "MindEase — Your AI Mental Health Companion" },
      {
        property: "og:description",
        content: "Daily journaling with sentiment analysis, coping strategies, streaks and anonymous peer support."
      },
...
const $$splitComponentImporter$4 = () => import("./repo-BesVTZbw.js");
const Route$4 = createFileRoute("/repo")({
  head: () => ({
    meta: [{
      title: "Repo & Deployment — MindEase"
    }, {
      name: "description",
      content: "GitHub repository structure, setup instructions and deployment plan for the MindEase project."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./pitch-DXbAUf9s.js");
const Route$3 = createFileRoute("/pitch")({
  head: () => ({
    meta: [{
      title: "Pitch Deck — MindEase"
    }, {
      name: "description",
      content: "MindEase pitch deck: problem, solution, tech stack, demo flow, impact and roadmap."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./demo-TTo6ZUTr.js");
const Route$2 = createFileRoute("/demo")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Try the MindEase mood journaling demo: AI-powered sentiment analysis with personalized coping strategies."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./architecture-CT3_Ha2G.js");
const Route$1 = createFileRoute("/architecture")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "System architecture, tech stack, and data flow for MindEase: React frontend, Node.js backend, MongoDB, and a Python ML sentiment service."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-Cw4TibXW.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "A privacy-first AI companion for daily mood journaling, personalized coping strategies and anonymous peer support. Built for students and professionals."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const RepoRoute = Route$4.update({
  id: "/repo",
  path: "/repo",
  getParentRoute: () => Route$5
});
const PitchRoute = Route$3.update({
  id: "/pitch",
  path: "/pitch",
  getParentRoute: () => Route$5
});
